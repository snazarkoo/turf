...
const rhumbCircle = require('./').default;
...
suite
    .add('turf-circle - 16 steps', () => rhumbCircle(center, radius, 16))
    .add('turf-circle - 32 steps', () => rhumbCircle(center, radius, 32))
    .add('turf-circle - 64 steps', () => rhumbCircle(center, radius, 64))
